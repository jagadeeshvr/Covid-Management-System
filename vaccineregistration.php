...
<head>
    ...
    <link rel="stylesheet" href="CSS files/stylevaccine.css">
...
<h1>VACCINE REGISTRATION </h1>
	...
	<div class="content">
		<div class="data" id="Free">
			...
			<br>
					<label> Mobile:</label>					
			<input type="text" name="pmobs" class="ip2"  maxlength="10">
			</br>
			<br>
			<br>
...
if(isset($_POST['sub1'])){
	...
	$sql="INSERT INTO vaccineregistration (`name`,`mobile`,`dob`,`cname`,`vname`,`dose`,`email`) VALUES ('$pname','$pmob','$padd','$hn','$bt','$dose','$email_id')";
...
$rands="P-$r1";
	...
	$sql="INSERT INTO vaccineregn (`name`,`mobile`,`dob`,`cname`,`vname`,`dose`,`email`) VALUES ('$pname','$pmob','$padd','$hn','$bt','$dose','$email_id')";
	$query=mysqli_query($conn,$sql);
