...
function createNote(){
	var nodeText=document.getElementById("note-text").value;
	...
	content2.insertAdjacentElement("beforeend",node0);
...
function color(){
	var random_color=["#2cff3d","#ff3de8","#3dc2ff","#04e022","#bc83e6","#ebb328"];
